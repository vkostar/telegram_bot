 ...
 */
@Component
public class KostarTelegramBot extends TelegramLongPollingBot {
    ...
    @Autowired
    public KostarTelegramBot(TelegramUserService telegramUserService, JavaRushGroupClient groupClient, GroupSubService groupSubService) {
